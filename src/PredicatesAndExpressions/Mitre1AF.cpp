...
char* Mitre1AF::final()
{
  _diff_lat = (_new_com_lat - _old_com_lat);
  _diff_long = (_new_com_long - _old_com_long);

 _diff_lat=_diff_lat>0?_diff_lat:-_diff_lat;
 _diff_long=_diff_long>0?_diff_long:-_diff_long;
